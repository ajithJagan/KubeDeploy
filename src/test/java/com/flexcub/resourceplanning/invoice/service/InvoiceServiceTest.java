...
class InvoiceServiceTest {
    ...
    void setInvoiceDetails() {
        ...
        detailResponse.setDueDate(new java.util.Date(2023, 1, 31));
...
//        assertEquals(1, invoiceRequest.getPartnerInvoiceResponseList().size());
    ...
    void getAdminInvoiceDataTest() {
        ...
        assertEquals(1, invoiceService.getAdminInvoiceData(skillSeeker.getId(), skillSeekerProjectEntity.getId()).size());
    }
    ...
    void saveInvoiceDetailsByAdminTest() {
        ...
        Mockito.when(adminInvoiceRepository.save(Mockito.any())).thenReturn(invoiceAdmin);
