...
class SkillSeekerTaskServiceImplTest {
    ...
    void beforeTest() {
        ...
        skillSeekerTaskTest.setSkillSeeker(skillSeekerEntity);
    ...
    void insertTaskDataTest() {
        ...
        assertEquals(1,service.insertData(skillSeekerTaskList).size());
    ...
    @Test
    void updateDataTest() {
        Optional<SkillSeekerTaskEntity> skillSeekerTaskEntity1 = Optional.of(new SkillSeekerTaskEntity());
        skillSeekerTaskEntity1.get().setId(1);
        Mockito.when(modelMapper.map(skillSeekerTaskTest, SkillSeekerTaskEntity.class)).thenReturn(skillSeekerTaskEntity1.get());
        Mockito.when(repository.findById(Mockito.anyInt())).thenReturn(skillSeekerTaskEntity1);
        Mockito.when(modelMapper.map(skillSeekerTaskEntity1, SkillSeekerTask.class)).thenReturn(skillSeekerTaskTest);
        assertEquals(skillSeekerTaskTest.getTaskId(), service.updateData(skillSeekerTaskTest).getTaskId());
