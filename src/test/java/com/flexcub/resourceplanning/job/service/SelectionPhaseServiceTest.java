...
//        scheduleInterviewDto.setModeOfInterview("virtual");
        ...
        requirementPhaseNew.setStatus(null);
        requirementPhaseNew.setSkillOwnerId(1);
        requirementPhaseNew.setDateOfInterview(LocalDate.of(2029, 12, 29));
        ...
        slotConfirmByOwnerDto.setDateSlotsByOwner1(new Date(2023, 01, 24));
        slotConfirmByOwnerDto.setDateSlotsByOwner2(new Date(2023, 01, 25));
        slotConfirmByOwnerDto.setDateSlotsByOwner3(new Date(2023, 01, 26));
