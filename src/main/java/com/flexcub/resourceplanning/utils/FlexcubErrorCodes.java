...
public enum FlexcubErrorCodes {
    ...
    INVALID_EMAIL_ID("FC1003", "Invalid email id"),
    INVALID_DOB("FC1004", "Invalid date of birth"),
    INVALID_PHONE("FC1005", "Invalid phone number"),
    INVALID_P_EMAIL("FC1006", "Invalid primary email id"),
    ...
    INVALID_SEEKER("FC1050", "Invalid user id"),
    ...
    NO_TIMESHEET_DATA("FC1098", "No timesheet data for given date frame"),
